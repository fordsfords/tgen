...
echo test1
./tgen_test -t 1 >tgen_test.out 2>&1 <<__EOF__
# comment
...
echo test2
./tgen_test -t 2 -f 1 -s "sendt 700 bytes 100 persec 1 sec; repl; sendt 700 bytes 100 persec 2 sec; repl; sendt 700 bytes 100 persec 3 sec" >tgen_test.out 2>&1 <<__EOF__
# comment
sendt 700 bytes 100 persec 20 sec
bad command
sendt 700 bytes 100 persec 21 sec
...
echo test6
rm -f time.out
command time -p -o time.out ./tgen_test -t 2 -f 1 -s "
sendt 700 bytes 100 persec 1 sec
set i 3
label l
  set j 2
...
command time -p -o time.out ./tgen_test -t 2 -s "set z 271828; sendt 700 bytes 100 persec 1 sec" >tgen_test.out 2>&1
STATUS=$?
...
rm -f time.out
# The set of variable 'z' is for the test assertion inside "my_send()".
command time -p -o time.out ./tgen_test -t 2 -s "set z 271828; sendc 700 bytes 100 persec 101 msgs" >tgen_test.out 2>&1
STATUS=$?
